...
ACCOUNTS = [
    ...
    {
        "name": "账号3",
        "L2_ADDRESS": "",  # 填写账号3的L2_ADDRESS
        "L2_PRIVATE_KEY": "",  # 填写账号3的L2_PRIVATE_KEY
    },
    {
        "name": "账号4",
        "L2_ADDRESS": "",  # 填写账号4的L2_ADDRESS
        "L2_PRIVATE_KEY": "",  # 填写账号4的L2_PRIVATE_KEY
    },
    {
        "name": "账号5",
        "L2_ADDRESS": "",  # 填写账号5的L2_ADDRESS
        "L2_PRIVATE_KEY": "",  # 填写账号5的L2_PRIVATE_KEY
    },
    {
        "name": "账号6",
        "L2_ADDRESS": "",  # 填写账号6的L2_ADDRESS
        "L2_PRIVATE_KEY": "",  # 填写账号6的L2_PRIVATE_KEY
    },
]

# ==================== 轮换切换条件 ====================
# 磨损切换阈值：每万成交量的磨损超过此值时切换账号
SWITCH_COST_PER_10K = 0.4  # 单位：元/万
...
MAX_VOLATILITY_PCT = 0.07            # 最大波动率（百分比），超过则暂停交易
